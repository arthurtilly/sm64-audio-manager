...
Run the file named  `windows.bat`. If Python is not already installed on your system, it will be installed first. This will open up the GUI for the tool. Alternatively, you can run `src/gui.py` from the command line or from a Python IDE.

### Linux

Run the script named `linux.sh`. This will also install Python and open the GUI. Alternatively, you can run `src/gui.py` from the command line or from a Python IDE.
